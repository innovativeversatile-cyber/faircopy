...
const en = {
  ...
  "what.p2": "Three pages are free — one PDF on this device. After that, a pass unlocks more copies.",
  "prices.title": "If you need another PDF",
  "prices.hint": "A pass stays on this device. Prices are set in the currency you choose — they are not live bank rates. One free PDF of three pages, then a pass.",
  "prices.tapToPay": "Tap a price to pay. Card checkout opens in this browser. The papers stay here.",
  "prices.workspace": "Need another PDF, or more than three pages? Pay here.",
  "prices.pay": "Pay",
  "plan.day": "One day",
  ...
  "foot.free": "One free PDF",
  "limit.title": "Three pages on the free copy",
  "limit.p": "That is the free copy on this device. Make this PDF, or pay for a longer packet.",
  "limit.used.title": "The free copy on this device is used",
  "limit.used.p": "That PDF stayed here. To make another, buy a pass. The pass stays on this device only.",
  ...
  "done.anotherPaid": "Buy a pass for another copy",
  "done.close": "Close",
  "done.payHint": "The free copy is used. A pass unlocks more PDFs on this device.",
  "pass.used": "The free copy on this device is used. A pass unlocks more PDFs.",
  ...
  "privacy.p4": "If you buy a pass, the card processor sees the payment, not your documents. The pass, the free-copy note, language, and currency are saved in this browser. Clearing the site data clears them.",
...
const sw = {
  ...
  "what.p2": "Kurasa tatu ni bure — PDF moja kwenye kifaa hiki. Baada ya hapo, pasi inafungua nakala zaidi.",
  "prices.title": "Ukhitaji PDF nyingine",
  "prices.hint": "Pasi inakaa kwenye kifaa hiki. Bei zimewekwa kwa sarafu uliyochagua — si viwango vya benki vya moja kwa moja. PDF moja bure ya kurasa tatu, kisha pasi.",
  "prices.tapToPay": "Gusa bei kulipa. Malipo ya kadi hufunguka kwenye kivinjari hiki. Karatasi zinabaki hapa.",
  "prices.workspace": "Unahitaji PDF nyingine, au zaidi ya kurasa tatu? Lipa hapa.",
  "prices.pay": "Lipa",
  "plan.day": "Siku moja",
  ...
  "foot.free": "PDF moja bure",
  "limit.title": "Kurasa tatu kwenye nakala ya bure",
  "limit.p": "Hiyo ni nakala ya bure kwenye kifaa hiki. Tengeneza PDF hii, au lipa kwa kifurushi kirefu.",
  "limit.used.title": "Nakala ya bure kwenye kifaa hiki imetumika",
  "limit.used.p": "PDF hiyo ilibaki hapa. Kutengeneza nyingine, nunua pasi. Pasi inakaa kwenye kifaa hiki tu.",
  ...
  "done.anotherPaid": "Nunua pasi kwa nakala nyingine",
  "done.close": "Funga",
  "done.payHint": "Nakala ya bure imetumika. Pasi inafungua PDF zaidi kwenye kifaa hiki.",
  "pass.used": "Nakala ya bure kwenye kifaa hiki imetumika. Pasi inafungua PDF zaidi.",
  ...
  "privacy.p4": "Ukinunua pasi, mchakato wa kadi unaona malipo, si nyaraka zako. Pasi, kumbukumbu ya nakala bure, lugha, na sarafu zinahifadhiwa kwenye kivinjari hiki. Kufuta data ya tovuti kunazifuta.",
...
const fr = {
  ...
  "what.p2": "Trois pages sont gratuites — un PDF sur cet appareil. Ensuite, un laissez-passer débloque d’autres copies.",
  "prices.title": "Si vous avez besoin d’un autre PDF",
  "prices.hint": "Le laissez-passer reste sur cet appareil. Les prix sont fixés dans la devise choisie — ce ne sont pas des cours bancaires en direct. Un PDF gratuit de trois pages, puis un laissez-passer.",
  "prices.tapToPay": "Touchez un prix pour payer. Le paiement par carte s’ouvre dans ce navigateur. Les papiers restent ici.",
  "prices.workspace": "Besoin d’un autre PDF, ou de plus de trois pages ? Payez ici.",
  "prices.pay": "Payer",
  "plan.day": "Un jour",
  ...
  "foot.free": "Un PDF gratuit",
  "limit.title": "Trois pages sur la copie gratuite",
  "limit.p": "C’est la copie gratuite sur cet appareil. Créez ce PDF, ou payez pour un plus long dossier.",
  "limit.used.title": "La copie gratuite sur cet appareil est utilisée",
  "limit.used.p": "Ce PDF est resté ici. Pour en faire un autre, achetez un laissez-passer. Il reste sur cet appareil seulement.",
  ...
  "done.anotherPaid": "Acheter un laissez-passer pour une autre copie",
  "done.close": "Fermer",
  "done.payHint": "La copie gratuite est utilisée. Un laissez-passer débloque d’autres PDF sur cet appareil.",
  "pass.used": "La copie gratuite sur cet appareil est utilisée. Un laissez-passer débloque d’autres PDF.",
  ...
  "privacy.p4": "Si vous achetez un laissez-passer, le prestataire de paiement voit le règlement, pas vos documents. Le laissez-passer, la note de copie gratuite, la langue et la devise sont enregistrés dans ce navigateur. Effacer les données du site les efface.",
...
const pt = {
  ...
  "what.p2": "Três páginas são grátis — um PDF neste aparelho. Depois disso, um passe desbloqueia mais cópias.",
  "prices.title": "Se precisar de outro PDF",
  "prices.hint": "O passe fica neste aparelho. Os preços estão na moeda que escolher — não são cotações bancárias ao vivo. Um PDF grátis de três páginas, depois um passe.",
  "prices.tapToPay": "Toque num preço para pagar. O pagamento com cartão abre neste navegador. Os papéis ficam aqui.",
  "prices.workspace": "Precisa de outro PDF, ou de mais de três páginas? Pague aqui.",
  "prices.pay": "Pagar",
  "plan.day": "Um dia",
  ...
  "foot.free": "Um PDF grátis",
  "limit.title": "Três páginas na cópia grátis",
  "limit.p": "Esta é a cópia grátis neste aparelho. Faça este PDF, ou pague por um maço mais longo.",
  "limit.used.title": "A cópia grátis neste aparelho já foi usada",
  "limit.used.p": "Esse PDF ficou aqui. Para fazer outro, compre um passe. O passe fica só neste aparelho.",
  ...
  "done.anotherPaid": "Comprar um passe para outra cópia",
  "done.close": "Fechar",
  "done.payHint": "A cópia grátis foi usada. Um passe desbloqueia mais PDF neste aparelho.",
  "pass.used": "A cópia grátis neste aparelho já foi usada. Um passe desbloqueia mais PDF.",
  ...
  "privacy.p4": "Se comprar um passe, o processador do cartão vê o pagamento, não os documentos. O passe, a nota da cópia grátis, a língua e a moeda ficam neste navegador. Limpar os dados do sítio apaga-os.",
...
const es = {
  ...
  "what.p2": "Tres páginas son gratis — un PDF en este aparato. Después, un pase desbloquea más copias.",
  "prices.title": "Si necesitas otro PDF",
  "prices.hint": "El pase se queda en este aparato. Los precios están en la moneda que elijas — no son tipos bancarios en vivo. Un PDF gratis de tres páginas, luego un pase.",
  "prices.tapToPay": "Toca un precio para pagar. El pago con tarjeta se abre en este navegador. Los papeles se quedan aquí.",
  "prices.workspace": "¿Necesitas otro PDF, o más de tres páginas? Paga aquí.",
  "prices.pay": "Pagar",
  "plan.day": "Un día",
  ...
  "foot.free": "Un PDF gratis",
  "limit.title": "Tres páginas en la copia gratis",
  "limit.p": "Esa es la copia gratis en este aparato. Haz este PDF, o paga por un fajo más largo.",
  "limit.used.title": "La copia gratis en este aparato ya se usó",
  "limit.used.p": "Ese PDF se quedó aquí. Para hacer otro, compra un pase. El pase se queda solo en este aparato.",
  ...
  "done.anotherPaid": "Comprar un pase para otra copia",
  "done.close": "Cerrar",
  "done.payHint": "La copia gratis está usada. Un pase desbloquea más PDF en este aparato.",
  "pass.used": "La copia gratis en este aparato ya se usó. Un pase desbloquea más PDF.",
  ...
  "privacy.p4": "Si compras un pase, el procesador de la tarjeta ve el pago, no tus documentos. El pase, la nota de la copia gratis, el idioma y la moneda se guardan en este navegador. Borrar los datos del sitio los borra.",
...
const pl = {
  ...
  "what.p2": "Trzy strony są darmowe — jeden PDF na tym urządzeniu. Potem przepustka odblokowuje kolejne kopie.",
  "prices.title": "Jeśli potrzebujesz kolejnego PDF",
  "prices.hint": "Przepustka zostaje na tym urządzeniu. Ceny są w wybranej walucie — to nie kursy bankowe na żywo. Jeden darmowy PDF z trzema stronami, potem przepustka.",
  "prices.tapToPay": "Dotknij ceny, żeby zapłacić. Płatność kartą otwiera się w tej przeglądarce. Papiery zostają tutaj.",
  "prices.workspace": "Potrzebujesz kolejnego PDF albo więcej niż trzech stron? Zapłać tutaj.",
  "prices.pay": "Zapłać",
  ...
  "foot.free": "Jeden darmowy PDF",
  "limit.title": "Trzy strony w darmowej kopii",
  "limit.p": "To darmowa kopia na tym urządzeniu. Zrób ten PDF albo zapłać za dłuższy plik.",
  "limit.used.title": "Darmowa kopia na tym urządzeniu jest wykorzystana",
  "limit.used.p": "Ten PDF został tutaj. Żeby zrobić kolejny, kup przepustkę. Zostaje tylko na tym urządzeniu.",
  ...
  "done.anotherPaid": "Kup przepustkę na kolejną kopię",
  "done.close": "Zamknij",
  "done.payHint": "Darmowa kopia jest wykorzystana. Przepustka odblokowuje kolejne PDF na tym urządzeniu.",
  "pass.used": "Darmowa kopia na tym urządzeniu jest wykorzystana. Przepustka odblokowuje kolejne PDF.",
  ...
  "privacy.p4": "Jeśli kupisz przepustkę, operator karty widzi płatność, nie dokumenty. Przepustka, notatka o darmowej kopii, język i waluta zostają w tej przeglądarce. Wyczyszczenie danych witryny je usuwa.",
...
const de = {
  ...
  "what.p2": "Drei Seiten sind frei — ein PDF auf diesem Gerät. Danach schaltet ein Pass weitere Kopien frei.",
  "prices.title": "Wenn Sie ein weiteres PDF brauchen",
  "prices.hint": "Der Pass bleibt auf diesem Gerät. Die Preise stehen in der gewählten Währung — das sind keine Live-Bankkurse. Ein kostenloses PDF mit drei Seiten, danach ein Pass.",
  "prices.tapToPay": "Tippen Sie auf einen Preis, um zu zahlen. Die Kartenzahlung öffnet sich in diesem Browser. Die Papiere bleiben hier.",
  "prices.workspace": "Noch ein PDF, oder mehr als drei Seiten? Zahlen Sie hier.",
  "prices.pay": "Zahlen",
  "plan.day": "Ein Tag",
  ...
  "foot.free": "Ein kostenloses PDF",
  "limit.title": "Drei Seiten in der freien Kopie",
  "limit.p": "Das ist die freie Kopie auf diesem Gerät. Erstellen Sie dieses PDF, oder zahlen Sie für ein längeres Paket.",
  "limit.used.title": "Die freie Kopie auf diesem Gerät ist verbraucht",
  "limit.used.p": "Dieses PDF ist hier geblieben. Für ein weiteres kaufen Sie einen Pass. Er bleibt nur auf diesem Gerät.",
  ...
  "done.anotherPaid": "Pass für eine weitere Kopie kaufen",
  "done.close": "Schließen",
  "done.payHint": "Die freie Kopie ist verbraucht. Ein Pass schaltet weitere PDF auf diesem Gerät frei.",
  "pass.used": "Die freie Kopie auf diesem Gerät ist verbraucht. Ein Pass schaltet weitere PDF frei.",
  ...
  "privacy.p4": "Wenn Sie einen Pass kaufen, sieht der Kartenanbieter die Zahlung, nicht Ihre Unterlagen. Pass, der Vermerk zur freien Kopie, Sprache und Währung bleiben in diesem Browser. Das Löschen der Seitendaten löscht sie.",
