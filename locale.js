...
const en = {
  ...
  "what.p2": "Three pages are free — enough for a letter, a form, or a card. A longer packet can be split into two PDFs, or unlocked with a pass.",
  "prices.title": "If you need more than three pages",
  ...
  "prices.workspace": "Need more than three pages? Pay here — you do not have to wait until you hit the limit.",
  "prices.pay": "Pay",
  "plan.day": "One day",
  ...
  "done.close": "Close",
  "done.payHint": "Need a longer packet next time? A pass stays on this device.",
...
const sw = {
  ...
  "what.p2": "Kurasa tatu ni bure — zinatosha barua, fomu, au kadi. Kifurushi kirefu kinaweza kugawanywa kuwa PDF mbili, au kufunguliwa kwa pasi.",
  "prices.title": "Ukhitaji zaidi ya kurasa tatu",
  ...
  "prices.workspace": "Unahitaji zaidi ya kurasa tatu? Lipa hapa — si lazima usubiri hadi kikomo.",
  "prices.pay": "Lipa",
  "plan.day": "Siku moja",
  ...
  "done.close": "Funga",
  "done.payHint": "Unahitaji kifurushi kirefu baadaye? Pasi inakaa kwenye kifaa hiki.",
...
const fr = {
  ...
  "what.p2": "Trois pages sont gratuites — assez pour une lettre, un formulaire, ou une carte. Un dossier plus long peut être coupé en deux PDF, ou débloqué avec un laissez-passer.",
  "prices.title": "Si vous avez besoin de plus de trois pages",
  ...
  "prices.workspace": "Besoin de plus de trois pages ? Payez ici — vous n’avez pas à attendre la limite.",
  "prices.pay": "Payer",
  "plan.day": "Un jour",
  ...
  "foot.free": "Trois pages gratuites",
  ...
  "done.close": "Fermer",
  "done.payHint": "Besoin d’un plus long dossier la prochaine fois ? Le laissez-passer reste sur cet appareil.",
...
const pt = {
  ...
  "what.p2": "Três páginas são grátis — chegam para uma carta, um formulário, ou um cartão. Um maço mais longo pode ser dividido em dois PDF, ou desbloqueado com um passe.",
  "prices.title": "Se precisar de mais de três páginas",
  ...
  "prices.workspace": "Precisa de mais de três páginas? Pague aqui — não tem de esperar pelo limite.",
  "prices.pay": "Pagar",
  "plan.day": "Um dia",
  ...
  "done.close": "Fechar",
  "done.payHint": "Precisa de um maço mais longo da próxima vez? O passe fica neste aparelho.",
...
const es = {
  ...
  "what.p2": "Tres páginas son gratis — basta para una carta, un formulario o una tarjeta. Un fajo más largo puede partirse en dos PDF, o desbloquearse con un pase.",
  "prices.title": "Si necesitas más de tres páginas",
  ...
  "prices.workspace": "¿Necesitas más de tres páginas? Paga aquí — no tienes que esperar al límite.",
  "prices.pay": "Pagar",
  "plan.day": "Un día",
  ...
  "done.close": "Cerrar",
  "done.payHint": "¿Necesitas un fajo más largo la próxima vez? El pase se queda en este aparato.",
...
const pl = {
  ...
  "what.p2": "Trzy strony są darmowe — starczy na list, formularz albo kartę. Dłuższy plik można podzielić na dwa PDF albo odblokować przepustką.",
  "prices.title": "Jeśli potrzebujesz więcej niż trzech stron",
  ...
  "prices.workspace": "Potrzebujesz więcej niż trzech stron? Zapłać tutaj — nie musisz czekać na limit.",
  "prices.pay": "Zapłać",
  ...
  "foot.free": "Trzy strony za darmo",
  ...
  "done.close": "Zamknij",
  "done.payHint": "Potrzebujesz dłuższego pliku następnym razem? Przepustka zostaje na tym urządzeniu.",
...
const de = {
  ...
  "what.p2": "Drei Seiten sind frei — genug für einen Brief, ein Formular oder eine Karte. Ein längeres Paket kann in zwei PDF geteilt oder mit einem Pass freigeschaltet werden.",
  "prices.title": "Wenn Sie mehr als drei Seiten brauchen",
  ...
  "prices.workspace": "Mehr als drei Seiten? Zahlen Sie hier — Sie müssen nicht auf das Limit warten.",
  "prices.pay": "Zahlen",
  "plan.day": "Ein Tag",
  ...
  "done.payHint": "Beim nächsten Mal ein längeres Paket? Der Pass bleibt auf diesem Gerät.",
